...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="font-semibold text-lg text-gray-800">Form Tambah Pengguna</h2>
        </div>
        ...
        <div class="p-6">
            ...
            <form action="{{ route('users.store') }}" method="POST">
                ...
                <div class="mb-4">
                    <label for="kata_sandi" class="block text-gray-700 text-sm font-bold mb-2">Password</label>
                ...
                <div class="mb-6">
                    ...
                    <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        <option value="tendik" {{ old('peran') == 'tendik' ? 'selected' : '' }}>Tendik</option>
                        <option value="sarpras" {{ old('peran') == 'sarpras' ? 'selected' : '' }}>Sarpras</option>
