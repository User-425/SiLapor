...
@section('content')
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-800">Edit Gedung</h1>
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="font-semibold text-lg text-gray-800">Form Edit Gedung</h2>
        </div>
            ...
            <form action="{{ route('gedung.update', $gedung->id_gedung) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                           id="deskripsi_lokasi" name="deskripsi_lokasi" rows="4">{{ old('deskripsi_lokasi', $gedung->deskripsi_lokasi) }}</textarea>
                </div>
