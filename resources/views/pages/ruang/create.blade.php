...
@section('content')
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-800">Tambah Ruang</h1>
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="font-semibold text-lg text-gray-800">Form Tambah Ruang</h2>
        </div>
        ...
        <div class="p-6">
            ...
            <form action="{{ route('ruang.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nama_ruang" name="nama_ruang" value="{{ old('nama_ruang') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                </div>

                <div class="mb-4">
                    <label for="deskripsi_lokasi" class="block text-gray-700 text-sm font-bold mb-2">Deskripsi Lokasi</label>
                    <textarea id="deskripsi_lokasi" name="deskripsi_lokasi" rows="4" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('deskripsi_lokasi') }}</textarea>
                </div>
